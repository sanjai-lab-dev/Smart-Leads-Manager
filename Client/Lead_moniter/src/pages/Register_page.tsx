...
export default function RegisterPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-tl from-green-900 via-cyan-900 to-indigo-800 flex items-center justify-center px-4">
      ...
      {/* Decorative Stars */}
      <div className="absolute -top-40 -left-40 text-[700px] font-black rotate-12 bg-gradient-to-br from-cyan-500/50 to-green-700/20 bg-clip-text text-transparent select-none pointer-events-none">
        *
      </div>
