      ...
      <div >
        ...
        <div className="md:ml-64 flex-1 overflow-y-auto p-6 pt-20">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            {/* Total Users */}
            <div className="bg-white px-5 py-3 rounded-2xl shadow-sm border border-gray-200 flex items-center gap-3">
          ...
          {/* Table Header */}
          <div className="grid grid-cols-5 bg-linear-to-r from-blue-500 to-indigo-700 text-white p-4 rounded-2xl font-semibold shadow-md mb-4">
            <p>Name</p>
            <p>Email</p>
            <p>Role</p>
                ...
                >
                  ...
                  <div className="flex justify-center">
                    <button 
                      ...
                      className="bg-yellow-100 text-yellow-800 hover:bg-yellow-200 px-4 py-2 rounded-xl text-sm font-medium transition-all shadow-sm flex items-center gap-2"
                    >
                      <Pencil size={16} />
                      Toggle
                    </button>
                  ...
                  <div className="flex justify-center">
                    <button 
                      ...
                      className="bg-red-100 text-red-700 hover:bg-red-200 px-4 py-2 rounded-xl text-sm font-medium transition-all shadow-sm flex items-center gap-2"
                    >
                      <Trash2 size={16} />
                      Delete
                    </button>
